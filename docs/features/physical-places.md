...
The full Yum Tong implementation will move this policy into a hardened main-process transaction service with a validated map, establishment, staff or machine, open-state, stock revision, and proximity context.
